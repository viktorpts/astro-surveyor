...
### Следващи стъпки
Изключвайки очевидното полиране на графичните елементи, интерфейса и добавянето на звукови ефекти, възможните пътища за продължение на проекта са описани в под-секциите [Вторичен](#вторичен-игрови-цикъл) и [Третичен](#третичен-игрови-цикъл-концептуален) игрови цикли на секция Действия на играча.
